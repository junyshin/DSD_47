...
ENTITY 	g47_5_comp IS
	...
	A : IN IEEE.NUMERIC_STD.unsigned(4 DOWNTO 0);
	B : IN IEEE.NUMERIC_STD.unsigned(4 DOWNTO 0);
	Eq : OUT std_logic
	);
END g47_5_comp;

-- Design Ports Information
-- Eq	=>  Location: PIN_V1,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- B[1]	=>  Location: PIN_R6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- A[3]	=>  Location: PIN_R5,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- B[3]	=>  Location: PIN_U1,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
-- B[4]	=>  Location: PIN_T2,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
...
ARCHITECTURE structure OF g47_5_comp IS
...
PORT MAP (
	dataa => \auto_signaltap_0|sld_signaltap_body|sld_signaltap_body|ela_control|run~regout\,
	datab => \auto_signaltap_0|sld_signaltap_body|sld_signaltap_body|ela_control|generated:ela_trigger_flow_mgr_entity|auto_generated|mgl_prim1|state_reg\(1),
...
-- Equation(s):
-- \Equal0~2_combout\ = (\Equal0~0_combout\ & (\Equal0~1_combout\ & (\A~combout\(4) $ (!\B~combout\(4)))))
...
PORT MAP (
	...
	datab => \auto_hub|jtag_hub_gen:sld_jtag_hub_inst|mixer_addr_reg\(4),
	datac => \auto_hub|jtag_hub_gen:sld_jtag_hub_inst|design_hash_reg~19_combout\,
